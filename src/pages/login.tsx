  ...
  const onSubmit = useCallback(
    async (data: ILogin) => {
      try {
        ...
        setError('email', {
            type: "server",
            message: 'Something went wrong with username'+err,
          });
      }
    },
    [reset]
      ...
      <div className="mx-auto w-full max-w-xl">
        <div className="w-full rounded-lg bg-white p-5 shadow-xl lg:w-11/12">
          ...
          <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-6">
              <button className="focus:shadow-outline w-full rounded-full bg-purple-500 px-4 py-2 font-bold text-white hover:bg-purple-700 focus:outline-none">
                Login
              </button>
            </div>
          </form>
          ...
          <div className="mt-4 flex gap-x-2">
            <button
              type="button"
              className="flex w-full items-center justify-center rounded-md border border-gray-600 p-2 hover:border-purple-700 focus:ring-2 focus:ring-violet-600 focus:ring-offset-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="h-5 w-5 fill-current hover:text-red-600"
              >
                <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
              </svg>
            </button>
            <button className="flex w-full items-center justify-center rounded-md border border-gray-600 p-2 hover:border-purple-700 focus:ring-2 focus:ring-violet-600 focus:ring-offset-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="h-5 w-5 fill-current hover:fill-current hover:text-purple-700"
              >
